...
| impact-regression.test.js | node | full | legacy-crosscutting | 21 | 0 | 0 |
...
| today-core.test.js | e2e | full | planning-execution, content-ai, ui-responsive | 211 | 6 | 10800 |
...
| core | legacy-crosscutting | 185 | 7 | code-index.test.js, commit-size-gate.test.js, impact-regression.test.js, release-gate.test.js, release-record.test.js, run-all-options.test.js, suite-manifest.test.js |
