...
| core | legacy-crosscutting | 204 | 6 | code-index.test.js, commit-size-gate.test.js, release-gate.test.js, release-record.test.js, run-all-options.test.js, suite-manifest.test.js |
