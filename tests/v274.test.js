...
(async () => {
  ...
  // v281: 後続リリースの実行コード変更ではCACHE_NAMEをさらに+1する契約。assertionは維持して最新版へ追従する。
  check("CACHE_NAMEは後続v281へ更新", /^const CACHE_NAME = "taskchute-journal-pwa-v281";/m.test(swSource));
